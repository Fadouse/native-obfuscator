...
public class StringPoolTest {
    ...
    public void testGet() {
        ...
        assertTrue(r1.startsWith("([pool](){ unsigned char key[32]"));
        assertTrue(r1.contains("string_pool::decrypt_string(0LL, 5, key, nonce)"));
        assertTrue(r1.endsWith("(char *)(pool + 0LL); })()"));

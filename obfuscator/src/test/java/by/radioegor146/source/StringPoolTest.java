...
public class StringPoolTest {
    ...
    public void testGet() {
        StringPool stringPool = new StringPool();
        String expr1 = stringPool.get("test");
        assertEquals(expr1, stringPool.get("test"));
        assertTrue(expr1.contains("(char *)(string_pool + 0LL)"));

        String expr2 = stringPool.get("\u0080\u0050");
        assertTrue(expr2.contains("(char *)(string_pool + 5LL)"));

        String expr3 = stringPool.get("\u0800");
        assertTrue(expr3.contains("(char *)(string_pool + 9LL)"));

        String expr4 = stringPool.get("\u0080");
        assertTrue(expr4.contains("(char *)(string_pool + 13LL)"));
    }
